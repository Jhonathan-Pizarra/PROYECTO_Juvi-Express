...
class ClientOrdersDetailPage extends StatelessWidget {
  ...
  Widget _dataDelivery() {
    return Container(
      ...
      child: ListTile(
        title: Text('Repartidor y Teléfono', style: TextStyle(color: Colors.teal)),
  ...
  Widget _dataAddress() {
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 20),
      child: ListTile(
        title: Text('Dirección de entrega', style: TextStyle(color: Colors.teal)),
  ...
  Widget _dataDate() {
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 20),
      child: ListTile(
        title: Text('Fecha del pedido', style: TextStyle(color: Colors.teal)),
